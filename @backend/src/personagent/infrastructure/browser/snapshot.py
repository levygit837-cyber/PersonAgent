...
class BrowserSnapshot:
    ...
    async def browser_element_map(self, page: Any) -> list[dict[str, Any]]:
        from personagent.infrastructure.browser.lightpanda import _BROWSER_ELEMENT_MAP_SCRIPT
    ...
    async def computed_html_snapshot(self, page: Any, current_url: str) -> str:
        from personagent.infrastructure.browser.lightpanda import _COMPUTED_HTML_SNAPSHOT_SCRIPT
