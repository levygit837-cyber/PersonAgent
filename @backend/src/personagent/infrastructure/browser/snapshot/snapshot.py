...
from personagent.infrastructure.browser.snapshot.elements import (
    browser_element_map,
    browser_frame_tree_snapshot,
    browser_iframe_element_map,
    enrich_browser_element_map,
)
from personagent.infrastructure.browser.snapshot.pipeline import (
    browser_view_snapshot,
    view_snapshot,
)
from personagent.infrastructure.browser.snapshot.styles import (
...
from personagent.infrastructure.browser.snapshot.tabs import (
    browser_tabs_snapshot,
    panel_session_tabs,
)
from personagent.infrastructure.persistence.artifacts import (  # noqa: F401
