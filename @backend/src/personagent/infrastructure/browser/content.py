...
class BrowserContent:
    ...
    async def extract_content(
        ...
        *,
        ...
        session = self._w._cached_usable_session(conversation_id)
        ...
        title = self._w._target_title(conversation_id, target_page_id)
        if page is not None:
        ...
        opened_page = self._w._opened_page(conversation_id, target_page_id) if target_page_id else None
        ...
        if opened_page is not None:
            ...
            if session is not None:
                await self._w._cleanup_live_pages(
                    conversation_id,
                    session,
