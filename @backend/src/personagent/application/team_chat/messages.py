"""Message and context builders for team-chat phases.

Pure functions that construct prompts, tool contexts, system messages,
and lightweight payloads used by AgentTurnRunner, ConsensusPhase,
CoordinatorPhase, and FinalSynthesis.
"""
...
# Phase constants used by builders
