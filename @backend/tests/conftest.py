...
Prevents ALL tests from scanning skill directories (~/.codex/skills,
...
def patch_skill_discovery(monkeypatch):
    """Block all skill filesystem scanning in tests.

    Loading 100+ real skills from ~/.codex/skills spikes RAM by 2GB+.
    Tests should use mocked skills, not scan the filesystem.
    """
